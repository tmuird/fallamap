      ...
      <ClerkProvider
        ...
        appearance={{
          ...
          elements: {
            ...
            socialButtonsBlockButton: "border-2 border-[#1A1A1A] shadow-[3px_3px_0px_0px_#1A1A1A] hover:shadow-none hover:translate-x-[1px] hover:translate-y-[1px] transition-all bg-white",
            formButtonPrimary: "border-2 border-[#1A1A1A] shadow-[3px_3px_0px_0px_#1A1A1A] hover:shadow-none hover:translate-x-[1px] hover:translate-y-[1px] transition-all bg-[#FF5F1F] text-white",
            footerActionLink: "text-[#FF5F1F] font-bold hover:underline",
            formFieldInput: "border-2 border-[#1A1A1A] rounded-xl px-4 h-12 bg-white focus:ring-2 focus:ring-[#FF5F1F]/20",
