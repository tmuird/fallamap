...
export default function ArchivePage() {
  return (
    <div className="min-h-screen bg-falla-paper py-12 md:py-24 px-4 md:px-8 flex items-center justify-center">
      <div className="max-w-4xl mx-auto text-center">
        <motion.div 
          ...
          className="space-y-8"
        >
          <div className="brutal-pill inline-block bg-white border-falla-ink/20 shadow-none px-6 py-2">
          ...
          <div className="flex flex-col items-center gap-6">
            ...
            <p className="text-falla-ink/60 font-medium text-lg md:text-2xl max-w-lg mx-auto leading-tight">
              We're currently documenting the <span className="text-falla-fire font-black">2026 festival</span>. Previous years will be restored to the digital heritage map after the final Cremà.
            </p>
          </div>

          <div className="pt-12 grid grid-cols-1 md:grid-cols-3 gap-4 text-falla-ink/20 font-black uppercase text-[10px] tracking-[0.3em]">
