  ...
  return (
    <div className="h-screen bg-falla-paper flex flex-col items-center relative overflow-hidden">
      ...
      <div className="z-10 w-full flex flex-col items-center h-full">
        ...
        <main className="w-full max-w-[1400px] px-4 md:px-8 flex-1 flex flex-col items-center justify-start md:justify-center -mt-8 md:mt-0">
          <div className="w-full flex flex-col gap-4 md:gap-10 items-center">
            ...
            >
              <h2 className="text-2xl md:text-7xl font-display text-falla-ink italic mb-3 md:mb-8 leading-tight">
                Discover the Magic.
              </h2>
              <Button 
                size="lg"
                className="bg-falla-fire text-white h-11 md:h-16 px-8 md:px-12 rounded-full text-xs md:text-lg shadow-solid hover:translate-y-[-2px] active:translate-y-0 transition-all border-2 border-falla-ink"
              >
            ...
            <motion.div 
              ...
              viewport={{ once: true }}
              className="w-full h-[28vh] md:h-[50vh] rounded-[2rem] md:rounded-[3.5rem] overflow-hidden ink-border shadow-solid bg-[url('/plaza.jpg')] bg-cover bg-center relative group max-w-4xl"
            >
        ...
        <div className="pb-4 md:pb-12 text-center shrink-0">
